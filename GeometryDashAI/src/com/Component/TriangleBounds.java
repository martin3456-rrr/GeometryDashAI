...
public class TriangleBounds extends Bounds{
    private final float base,height,halfWidth,halfHeight;
    private final float enclosingRadius;
    ...
    private boolean narrowPhase(BoxBounds b1)
    {
        ...
        Vector2 origin = new Vector2(b1.gameObject.transform.position.x+((float)b1.width/2.0f),b1.gameObject.transform.position.y+((float)b1.height/2.0f));
