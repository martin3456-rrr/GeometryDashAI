...
public class TriangleBounds extends Bounds{
    ...
    private float encclosingRadius;
    ...
    {
        this.type = BounsType.Triangle;
        this.base=base;
        this.height=height;
        this.halfWidth = this.base/2.0f;
        this.halfHeight = this.height/2.0f;
        this.encclosingRadius = Math.max(this.halfHeight,this.halfWidth);
    }
    @Override
    public void start()
    {
    ...
    public static boolean checkColiision(BoxBounds b1, TriangleBounds t2)
    {
        if(t2.broadPhase(b1))
        {
    ...
    private boolean broadPhase(BoxBounds b1)
    {
       ...
       float tRadius = this.encclosingRadius;
    ...
    private boolean narrowPhase(BoxBounds b1)
    {
        ...
        Vector2 origin = new Vector2(b1.gameObject.transform.position.x+(b1.width/2.0f),b1.gameObject.transform.position.y+(b1.height/2.0f));
    ...
    private int computeRegionCode(Vector2 point,BoxBounds bounds) {
        ...
        //Check if the pouint is to the left or right of bounds
    ...
    public boolean raycast(Vector2 position) {
        ...
        float invDenom = 1/(dot00*dot01*-dot01*dot01);
    ...
    public String serialize(int tabSize) {
        ...
        builder.append(addFloatProperty("Width",this.base,tabSize+1,true,true));
